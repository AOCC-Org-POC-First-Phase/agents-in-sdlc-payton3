...
This module provides functions to populate the database with initial game data.
"""
import csv
import os
import random
...
def create_games() -> None:
    ...
    This function reads game data from a CSV file and populates the database
    with games, automatically creating associated categories and publishers
    as needed. It also generates random star ratings for each game.
...
def seed_database() -> None:
    ...
    the database with initial game, category, and publisher data.
    """
    create_games()
